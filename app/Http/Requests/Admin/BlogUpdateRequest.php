...
class BlogUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'content' => 'required',
            'thumbnail_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:2048|dimensions:width=700,height=430',
            'banner_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:4096|dimensions:width=1140,height=420',
